...
Обратите внимание, что ваш браузер может кешировать устаревшие pdf файлы (~ четырёхчасовой давности, особенно актуально в период подготовки к коллоквиуму), актуальные файлы всегда находятся [здесь](https://github.com/LoDThe/hse-tex/tree/gh-pages).
