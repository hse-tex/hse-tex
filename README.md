...
- Если необходимо быстро найти обозначение какого-то математического символа, можно использовать [этот](https://oeis.org/wiki/List_of_LaTeX_mathematical_symbols) ресурс.
