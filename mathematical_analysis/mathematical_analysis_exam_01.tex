...
\title{\HugeМатематический анализ, Экзамен 1}
\author{
	Балюк Игорь \\
...
\begin{document}
    ...
    \proofitem{Числовые последовательности. Примеры.}
	...
	\proofitem{Понятие предела последовательности.}
	...
	\proofitem{Ограниченные и неограниченные последовательности.}
	...
	\proofitem{Теорема об ограниченности сходящейся последовательности.}
	...
	\proofitem{Теорема о единственности предела сходящейся последовательности.}
	...
	\proofitem{Теорема о переходе к пределу в неравенствах.}
	...
	\proofitem{Теорема о вынужденном пределе.}
	...
	\proofitem{Теорема о сходимости монотонных ограниченных последовательностей.}
	...
	\proofitem{Бесконечно малые последовательности.}
		...
		\proofitem{Связь со сходящимися последовательностями.}
	...
	\proofitem{Арифметические свойства бесконечно малых и сходящихся последовательностей.}
	...
	\proofitem{Арифметические свойства для последовательностей, имеющих конечные и бесконечные пределы.}
	...
	\proofitem{Определение подпоследовательности.}
	...
	\proofitem{Теорема Больцано-Вейерштрасса.}
	...
	\proofitem{Критерий Коши сходимости последовательности.}

		\begin{theorem*}
			Для того, чтобы последовательность $\{x_n\}$ сходилась, необходимо и достаточно, чтобы она была фундаментальной.
	...
	\proofitem{Определение предела функции в точке по Коши и по Гейне.}
	...
	\proofitem{Теорема об эквивалентности этих определений.}
	...
	\proofitem{Односторонние пределы, их связь с двусторонними. Пределы функции в бесконечности.}

		Назовём число $A$ левым (правым) пределом $f$ по Коши, если:
		\begin{equation*}
			\forall \eps > 0 \; \exists \delta > 0: \; \forall x \in (a - \delta; a) (x \in (a; a + \delta)) \implies |f(x) - A| < \eps
		\end{equation*}
	...
	\proofitem{Первый и второй замечательные пределы.}
	...
	\subsubsection{Первый замечательный предел}
		...
		\href{http://ru.solverbook.com/spravochnik/predely/pervyj-zamechatelnyj-predel/}{Доказательство}
	...
	\subsubsection{Второй замечательный предел}
		...
		\begin{proof}
			Будем пользоваться тем фактом, что $e = \lim\limits_{n \to \infty} \left(1 + \dfrac{1}{n}\right)^n$ (тут $n \in \NN$, а $x$ в утверждении --- может быть не целым)
	...
	\proofitem{Критерий Коши существования конечного предела функции.}

		\begin{theorem*}
			Для того, чтобы функция $f$ имела конечный предел в точке $x_0$, необходимо и достаточно, чтобы выполнялось условие Коши: для любого $\eps > 0$ существовало такое число $\delta > 0$, что для всех $u, v \in X$ из неравенств $0 < |u - x_0| < \delta, 0 < |v - x_0| < \delta$ следует неравенство $|f(u) - f(v)| < \eps$.
		\end{theorem*}

		\href{http://elisey-ka.ru/matan/exm/18.htm}{Доказательство}

	\proofitem{Определение непрерывности функции в точке.}
    ...
    \proofitem{Точки разрыва, их классификация.}
	...
	\proofitem{Критерий существования и непрерывности обратной функции на промежутке}
	...
	\proofitem{Инвариативность формы первого дифференциала}

		Найдем выражение для дифференциала сложной функции. Пусть $y = f(u(x))$. Тогда
		\begin{equation*}
			dy = y'(x) \cdot dx = f'(u(x)) \cdot u'(x) \cdot dx = f' \cdot du
		\end{equation*}
    ...
    \section{Вопросы, которые были убраны из программы экзамена}
