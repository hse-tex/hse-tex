...
\begin{document}
	...
	\addtocounter{colloqi}{1}

	\proofitem{[TODO(): ] Неопределенности. Теоремы о переходе к пределу в неравенствах, о вынужденном пределе.}

	\proofitem{[TODO(): ] Первый и второй замечательные пределы.}

	\proofitem{[TODO(): ] Критерий Коши существования конечного предела функции.}
