...
\begin{document}
	...
	\begin{itemize}
		...
		\begin{equation*}
			\{x_n\} \text{ ограниченная сверху } \iff \exists M \in X: \; \forall n \implies x_n \leq M
		\end{equation*}
		...
		\begin{equation*}
			\{x_n\} \text{ ограниченная снизу } \iff \exists m \in X: \; \forall n \implies x_n \geq m
		\end{equation*}
		...
		\begin{equation*}
			\{x_n\} \text{ ограниченная } \iff \exists M, m \in X: \; \forall n \implies m \leq x_n \leq M
		\end{equation*}
	...
	\begin{proof}
		 ...
		 \begin{equation*}
		 	b - a = |b - a| = |b - x_n + x_n - a| \geq |x_n - b| + |x_n - a| < \dfrac{b - a}{2} + \dfrac{b - a}{2} = b - a
		 \end{equation*}
	...
	\end{theorem*}
	\begin{proof}
		Из определения предела $\{x_n\}$, $\forall \eps > 0 \; \exists N_1: \; \forall n \geq N_1 \implies |x_n - a| < \eps \iff a - \eps < x_n < a + \eps$. Аналогично для предела $\{z_n\}$, $\forall \eps > 0 \; \exists N_2: \; \forall n \geq N_2 \implies |z_n - a| < \eps \iff a - \eps < z_n < a + \eps$. Тогда, 
		$\forall n \geq \max \{N_1, N_2, N\} \implies \\a - \eps < x_n \leq y_n \leq z_n < a + \eps \implies \lim\limits_{n \to \infty} y_n = a$.
	\end{proof}
		...
		\item
 		...
 		\begin{proof}
 			...
 			\[\begin{gathered}
 				...
 				\text{Тогда при } N = \max\{N_1, N_2\} \implies \forall n \geq N \implies
 				|\alpha_n \pm \beta_n| \leq |\alpha_n| \cdot |\beta_n| < \frac{1}{\eps} \cdot \eps^2 = \eps
 			\end{gathered}\]
 		\end{proof}
	\end{itemize}
	...
	\begin{proof}
		...
		\end{gathered}\]
		По лемме $\left|\frac{1}{y_n \cdot b}\right| \leq max\left\{\left|\frac{1}{y_1 \cdot b}\right|, \dots, \left|\frac{1}{y_N \cdot b}\right|, \frac{1}{rb} \right\} \implies \{\frac{1}{y_n \cdot b}\}$ ограничена. Но тогда имеем произведение бесконечно малой и ограниченной последовательностей, значит, $\{\dfrac{x_n}{y_n} - \dfrac{a}{b}\}$ --- бесконечно малая.
	\end{proof}
