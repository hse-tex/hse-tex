...
\begin{document}
    ...
    \section{Формула Стирлинга.}
   		...
   		\begin{proof}
   			...
   			Но
   			\begin{equation*}
   				\dfrac{((2n)!!)^2}{(2n + 1)!!(2n - 1)!!} = \dfrac{((2n)!!)^4}{(2n + 1)((2n)!)^2} = \dfrac{(2^n n!)^4}{(2n + 1)((2n)!)^2} \sim \dfrac{2^{4n}c^4n@(n / e)^{4n}}{c^2(2n + 1)2n((2n)/e)^{4n}}.
   			\end{equation*}
    ...
    \section{Несобственный интеграл Римана: определение и примеры. Регулярность и линейность несобственного интеграла, независимость сходимости интеграла от его <<начала>>. Формула интегрирования по частям и замены переменной для несобственного интеграла.}
    	...
    	\item
    		$\int\limits_{t \in [\alpha; \beta]} |v(t)| \cdot (\beta - \alpha) \leq l(\alpha, \beta) \leq \sup\limits_{t \in [\alpha; \beta]}$, где $v(t) =  (x'(t), y'(t), z'(t))$
    	\end{enumerate}
