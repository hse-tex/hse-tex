...
\begin{document}
    ...
    \begin{enumerate}
        ...
        $r_n = S - S_n$, тогда $\dfrac{\sqrt{r_{n}} - \sqrt{r_{n+1}}}{a_{n+1}} = \dfrac{\sqrt{S - S_n} - \sqrt{S - S_{n+1}}}{a_{n+1}} = \dfrac{S_{n+1} - S{n}}{(S_{n+1} - S_n)(\sqrt{S - S_n} + \sqrt{S - S_{n+1}})}$, где $(S_{n+1} - S_n)(\sqrt{S - S_n} + \sqrt{S - S_{n+1}}) \rightarrow \infty$, $\dfrac{S_{n+1} - S{n}}{(S_{n+1} - S_n)(\sqrt{S - S_n} + \sqrt{S - S_{n+1}})} \rightarrow 0$. Тогда ряд $\sum (\sqrt{r_{n}} - \sqrt{r_{n+1}})$ расходится, причём медленнее, чем ряд $\sum a_{n+1}$.
        ...
        $\dfrac{\sqrt{S_{n+1}} - \sqrt{S_n}}{a_{n+1}} = \dfrac{\sqrt{S_{n+1}} - \sqrt{S_n}}{S_{n+1} - S_n} = \dfrac{1}{\sqrt{S_{n+1}} + \sqrt{S_n}}$, где $\sqrt{S_{n+1}} + \sqrt{S_n} \rightarrow \infty$, а значит $\dfrac{1}{\sqrt{S_{n+1}} + \sqrt{S_n}} \rightarrow 0$. Тогда ряд $\sum (\sqrt{S_{n+1}} - \sqrt{S_n})$ расходится, причём медленнее, чем ряд $\sum a_{n+1}$.
