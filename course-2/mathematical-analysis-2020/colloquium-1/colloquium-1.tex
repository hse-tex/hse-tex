...
\begin{document}
    ...
    \defitem{Докажите, что если для положительного ряда $\sum a_n$ существует $\lim \frac{a_{n + 1}}{a_n} = q$, то существует и $\lim \sqrt[n]{a_n} = q$.}
        ...
        Заметим, что
        \begin{equation*}
            \lim \frac{a_{n + 1}}{a_n} = q \iff 
            \overline{\lim} \frac{a_{n + 1}}{a_n} = \underline{\lim} \frac{a_{n + 1}}{a_n}.
        \end{equation*}

        Вспомним неравенство из предыдущего пункта:
        \begin{equation*}
            \underline{\lim} \dfrac{a_{n+1}}{a_n} \leq \underline{\lim}{\sqrt[n]{a_n}} \leq \overline{\lim}{\sqrt[n]{a_n}} \leq \overline{\lim}\dfrac{a_{n+1}}{a_n}.
        \end{equation*}
        ...
        \begin{equation*}
            q \leq \underline{\lim}{\sqrt[n]{a_n}} \leq \overline{\lim}{\sqrt[n]{a_n}} \leq q.
        \end{equation*}

        То есть мы зажали предел с двух сторон с помощью $q$. Тогда
        \begin{equation*}
            \lim \sqrt[n]{a_n} = q.
        \end{equation*}
    ...
    \defitem{Приведите пример положительного ряда, вопрос о поведении которого не может быть решен с помощью признака Гаусса (с обоснованием).}
        ...
        Анализируем положительный ряд $\sum_{n=1}^{\infty} \dfrac{1}{n \ln^p n}$ с общим членом $a_n = \dfrac{1}{n \ln^p n}$.

        Рассмотрим отношение:
        \begin{align*}
            \dfrac{a_{n + 1}}{a_n} 
            &= \dfrac{n \ln^p n}{(n + 1) \ln^p (n + 1)} \\
            & = \dfrac{n}{n + 1} \cdot \dfrac{\ln^p n}{\ln^p (n + 1)} \\
            &= \dfrac{1}{1 + 1/n} \cdot \dfrac{\ln^p n}{\left( \ln n + \ln (1/n)\right)^p} \\
            &= \left[\text{ По формуле Тейлора для $(1+x)^{-1}$ и $\ln (1+x) \sim x$ }\right] \\
            &= \left(1 - \dfrac{1}{n} + \dfrac{1}{n^2} + o\left(\dfrac{1}{n^2}\right)\right) \cdot \left(1 + \dfrac{1/n + \o(1/n)}{\ln n}\right)^{-p} \\
            &= \left[\text{ Перешли к менее строгому приближению и  снова разложили $(1+x)^{-p}$ }\right] \\
            &= \left(1 - \dfrac{1}{n} + \o\left(\dfrac{1}{n \ln n}\right)\right) \cdot \left(1 - \dfrac{p}{n \ln n} + \o\left(\dfrac{1}{n \ln n}\right)\right) \\
            &= 1 - \dfrac{1}{n} - \dfrac{p}{n \ln n} + \o\left(\dfrac{1}{n \ln n}\right).
        \end{align*}
        
        Для использования признака Гаусса должны получить приближение 
        \begin{equation*}
            1 - \dfrac{q}{n} + \operatorname{O}\left( \dfrac{1}{n^{1+\delta}} \right),
        \end{equation*}
        где $\delta > 0$.

        Но при этом имеем
        \begin{equation*}
            - \dfrac{1}{n} - \dfrac{p}{n \ln n} + \o\left(\dfrac{1}{n \ln n}\right) \neq \operatorname{O}\left( \dfrac{1}{n^{1+\delta}} \right),
        \end{equation*}
        потому что 
        $\dfrac{1}{\ln n} > \dfrac{1}{n^{\delta}}$ для любых $\delta > 0$ при $n$, стремящемся к $\infty$.
    ...
    \defitem{Сформулируйте свойство абсолютно сходящегося ряда, связанное с перестановкой членов.}
        ...
        \begin{theorem*}
            Если ряд $\sum a_n$ сходится абсолютно, то любой ряд, полученный из него перестановкой членов, сходится абсолютно к той же сумме.
        \end{theorem*}
    ...
    \defitem{Как определяется произведение рядов? Что можно утверждать о произведении абсолютно сходящихся рядов?}
        ...
        \begin{equation*}
            \left(\sum_{k=1}^{K} a_k\right) \cdot \left(\sum_{m=1}^{M} b_m \right) = \sum_{1 \leq k \leq K, 1 \leq m \leq M} a_k \cdot b_m = \sum_{n=1}^{\infty} c_n,\quad c_n = \sum_{k=1}^{n} a_k\cdot b_{n - k}
        \end{equation*}

        \begin{theorem*}
        (Коши) Если $\sum a_k$, $\sum b_m$ сходятся абсолютно, то их произведение сходится абсолютно.
        \end{theorem*}
    ...
    \defitem{Сформулируйте и докажите необходимое условие сходимости бесконечного произведения.}
        ...
        \begin{proof}
            Так как бесконечное произведение сходится, имеем
            \begin{equation*}
                P_N \to \prod_{n = 1}^{\infty} a_n;
                \quad\quad\quad
                P_{N - 1} \to \prod_{n = 1}^{\infty} a_n.
            \end{equation*}

            Тогда заметим следующий факт:
            \begin{equation*}
                a_N = \dfrac{P_N}{P_{N - 1}} \to 1.
            \end{equation*}
        \end{proof}
    ...
    \defitem{В каком случае бесконечное произведение называется сходящимся абсолютно? Сформулируйте и докажите критерий абсолютной сходимости бесконечного произведения.}
        ...
        \begin{proof}
            Пусть $a_n = 1 + \alpha_n$, где $\{\alpha_n\}$ --- бесконечно малая последовательность, то есть $\alpha_n \to 0$.

            Рассмотрим критерий:

            $\prod_{n = 1}^{\infty} a_n$ сходится абсолютно тогда и только тогда, когда абсолютно сходится ряд $\sum_{n = 1}^{\infty} (a_n - 1)$. 

            Заметим следующее:
            \begin{equation*}
                \ln a_n = \ln (\alpha_n + 1) = \alpha_n + \operatorname{o}(\alpha_n).
            \end{equation*}

            Отсюда получаем, что $|\ln a_n| = |\alpha_n| \cdot (1 + \operatorname{o}(1))$, то есть $|\ln a_n| \simeq |\alpha_n|$.
        \end{proof}
    ...
    \defitem{Приведите пример функциональной последовательности $\{f_n(x)\}$ (с нетривиальной зависимостью от $n$ и $x$), равномерно сходящейся на некотором множестве (с обоснованием)}
        ...
        Нетривиальная зависимость означает, что общий член зависит как от $n$, так и от $x$.

        \begin{example}
            Пусть $D = [0; +\infty)$ и $f_n(x) = \dfrac{1}{n + x}$.

            Докажем, что $f_n(x) \overset{D}{\rightrightarrows} 0$:
            \begin{equation*}
                \norm{f_n - 0} = \norm{f_n} = \sup_{x \in D} |f_n(x)| = \dfrac{1}{n} \to 0.
            \end{equation*}
        \end{example}
    ...
    \defitem{Докажите, что если две функциональные последовательности сходятся равномерно к предельным функциям, то их сумма также сходится равномерно к сумме этих предельных функций.}
        ...
        \begin{theorem*}
            Пусть $f_n \overset{D}{\rightrightarrows} f$ и $g_n \overset{D}{\rightrightarrows} g$, тогда $(f_n + g_n) \overset{D}{\rightrightarrows} (f + g)$.
        \end{theorem*}
        
        \begin{proof}
            По определению равномерной сходимости:
            \[\begin{gathered}
                \forall \eps > 0 \; \exists N_1(\eps) : |f_n(x) - f(x)| < \dfrac{\eps}2 \;\;\; \forall n \ge N_1(\eps)\;\; \forall x \in D; \\
                \forall \eps > 0 \; \exists N_2(\eps) : |g_n(x) - g(x)| < \dfrac{\eps}2 \;\;\; \forall n \ge N_2(\eps)\;\; \forall x \in D.
            \end{gathered}\]

            Тогда для любого $x$ из $D$ и для любого $n \geq \max\{N_1, N_2\}$:
            \begin{equation*}
                |(f_n(x) + g_n(x)) - (f(x) + g(x))|  = |(f_n(x) - f(x)) + (g_n(x) - g(x))| \le |f_n(x) - f(x)| + |g_n(x) - g(x)| < \dfrac{\eps}2 + \dfrac{\eps}2 = \eps.
            \end{equation*}

            Но тогда
            \begin{equation*}
                \forall \eps > 0 \; \exists N = \max\{N_1, N_2\} : |(f_n(x) + g_n(x)) - (f(x) + g(x))| < \eps \;\;\; n \ge N \;\; \forall x \in D,
            \end{equation*}
            то есть сумма $(f_n + g_n)$ равномерно сходится к $(f + g)$ на $D$.
        \end{proof}  
    ...
    \defitem{Докажите, что если две функциональные последовательности сходятся равномерно к ограниченным предельным функциям, то их произведение также сходится равномерно к произведению этих предельных функций.}
        ...
        \begin{proof}
            Пусть наши последовательности --- $\{f_n\}, \, \{g_n\};$, а их предельные функции --- $f, g$ соотв.
            
            Знаем: $\forall \; \eps_1, \eps_2 \; \exists \; N_1(\eps_1), \, N_2(\eps_2): |f_n(x) - f(x)| < \eps_1; \; |g_m(x) - g(x)| < \eps_2$ при $n \geq N_1(\eps_1), \;m \geq N_2(\eps_2).$
            ...
            & = |g_n(x)| \cdot |f_n(x) - f(x)| + |f(x)| \cdot |g(x) - g_n(x)| \leq C_2 \cdot \epsilon_1 + C_1 \cdot \epsilon_2 \text{ (начиная с $n = \max(N_1(\eps_1), N_2(\eps_2))$.}
            \end{flalign}
            Теперь возьмем произвольный $\eps > 0$, и положим $\eps_1 = \frac{\eps}{3 \cdot C_2}; \; \eps_2 = \frac{\eps}{3 \cdot C_1}.$  
            
            Начиная с $n = \max\{N_1(\eps_1), N_2(\eps_2)\}$ верно, что $|f_n(x) \cdot g_n(x) - f(x) \cdot g(x)| \leq \eps/3 + \eps/3 < \eps$.
        \end{proof}
    ...
    \defitem{Пусть функциональная последовательность $\{f_n\}$ сходится равномерно на множестве $D$ к предельной функции $f$, отделённой от нуля (т.е. $\inf_{x \in D} |f(x)| > 0$), то функциональная последовательность $\{f_n\}$ сходится равномерно на $D$ к $f$.}
        ...
        \begin{proof}
            \begin{flalign*}
                ...
                \sup_{x \in D}{\left|\frac{f_n - f}{f_n \cdot f}\right|} \leq \sup_{x \in D} \frac{\epsilon}{|f_n \cdot f|} \; \text{ при } n \geq N(\epsilon), \;  \text{т.к. } \norm{f_n - f} \leq \epsilon \text{ при } n \geq N(\epsilon).
                \\ \\
            ...
            \end{flalign*}
            Так как $\frac{2}{m^2}$ - фиксированное число, а $\eps$ у нас --- сколь угодно малое, то это означает, что $\norm{\frac{1}{f_n} - \frac{1}{f}} \to 0,$ что является по определению равномерной сходимостью $f_n$ к  $f$.
        \end{proof}
    ...
    \defitem{Докажите, что предел равномерно сходящейся последовательности непрерывных функций является непрерывной функцией.}
        ...
        \begin{proof}
            Пусть функция $s(x)$ $-$ предел некоторой последовательности непрерывных функций $s_n(x)$. Тогда непрерывность функции $s(x)$, которую нам нужно доказать, по определению будет заключаться в том, что в любой точке $x_0$ для любого $\eps > 0$ можно найти такое $\delta$, что из $|h| < \delta$ следует, что $|s(x_0 + h) - s(x_0)| < \eps$.

            Для любых $x_0, h, n$ имеем
            \begin{align*}
                |s(x_0 + h) - s(x_0)| 
                &= |s(x_0 + h) - s_n(x_0 + h) + s_n(x_0 + h) - s_n(x_0) + s_n(x_0) - s(x_0)| \\
                &\leq |s(x_0 + h) - s_n(x_0 + h)| + |s_n(x_0 + h) - s_n(x_0)| + |s_n(x_0) - s(x_0)|.
            \end{align*}

            По определению равномерной сходимости мы можем взять такое $n$, что для любого $x_0$ будет выполняться неравенство $|s(x_0) - s_n(x_0)| < \frac{\eps}{3}$. Значит справедливы неравенства:
            \[\begin{gathered}
                |s(x_0 + h) - s_n(x_0 + h)| < \frac{\eps}{3}; \\
                |s(x_0) - s_n(x_0)| < \frac{\eps}{3}.
            \end{gathered}\]

            Итак, пусть мы зафиксировали некоторое $n$, тогда, поскольку функция $s_n(x)$ монотонна по условию, найдётся такое $\delta$, что для любого $|h| < \delta$ выполняется неравенство $|s_n(x_0 + h) - s_n(x_0)| < \frac{\eps}{3}$. Таким образом
            \begin{equation*}
                |s(x_0 + h) - s(x_0)| \leq |s(x_0 + h) - s_n(x_0 + h)| + |s_n(x_0 + h) - s_n(x_0)| + |s_n(x_0) - s(x_0)| < \frac{\eps}{3} + \frac{\eps}{3} + \frac{\eps}{3} = \eps.
            \end{equation*}
        \end{proof}
    ...
    \defitem{Сформулируйте теорему Дини о монотонной сходимости. Приведите пример её применения для доказательства равномерной сходимости функциональной последовательности (с обоснованием).}
        ...
        \begin{theorem*}
            Пусть $f_n: [a, b] \to \RR, f_n(x)$ монотонна по $n$ при каждом $x \in [a, b]$, $f_n \to f$ на $[a, b]$ и $f$ непрерывна.
    ...
    \defitem{Приведите контрпример, показывающий, что в формулировке теоремы Дини о монотонной сходимости нельзя отказаться от условия непрерывности предельной функции (с обоснованием)}    

        Рассмотрим функциональную последовательность $f_n(x) = \dfrac{1}{1 + nx}$ на множестве $D = [0;1]$. Поймём, что некоторые условия для теормы Дини выполняются:
        \begin{itemize}
        \item
            $D$ --- компакт (ограниченное замкнутое множество).

        \item 
            $f_n$ монотонно убывает на $D$.

        \item 
            $f_n$ непрерывна на $D$.
        \end{itemize}

        Докажем, что не выполняется условие на непрерывность предельной функции.

        Заметим, что
        \begin{equation*}
            f_n(x) \to^{n \to \infty} f(x) = \begin{cases}
                1, &x = 0; \\
                0, &x \neq 0.
            \end{cases}
        \end{equation*}
        
        То есть $f_n$ сходится неравномерно на $D$.
    ...
    \defitem{Покажите на примере как доказать неравномерность сходимости функциональной последовательности с помощью локализации особенности (с обоснованием).}
        ...
        Надо рассмотреть $f_n = \dfrac{1}{x^n}$ на множестве $D = (1; +\infty)$.

        Заметим, что $f_n \overset{D}{\to} f = 0 $, но при этом имеем
        \begin{equation*}
            f_n \to \begin{cases}
                1, &x = 1; \\
                0, &x > 1.
        ...
        Получили, что, если добавить точку, непрерывная функция стремится к разрывной. То есть локализовали особенность, а значит функциональная последовательность $f_n$ сходится неравномерно.

    \defitem{Сформулируйте и докажите теорему о почленном переходе к пределу в функциональной последовательности.}

        \begin{theorem*}
            Если функциональная последовательность ${f_n(x)}$ сходится равномерно на множестве ${x}$ к предельной функции $f(x)$ и все элементы этой последовательности имеют предел в точке $x_0$, то и предельная функция  имеет предел в точке $x_0$, причём $\lim_{x \rightarrow x_0} f(x) = \lim_{x \rightarrow x_0}(\lim_{n \rightarrow \infty} f_n(x)) = \lim_{n \rightarrow \infty}(\lim_{x \rightarrow x_0} f_n(x))$, т.e. символ $\lim_{n \rightarrow \infty}$ предела последовательности и символ $\lim_{x \rightarrow x_0}$ предела функции можно переставлять местами (или, как говорят, к пределу при $x \rightarrow x_0$ можно переходить почленно).
        \end{theorem*}

    \defitem{Сформулируйте теорему о почленном дифференцировании функциональной последовательности.}

        \begin{theorem*}
            Пусть $a, b \in [-\infty; +\infty]$ и $D = (a; b)$ или $D = [a; b]$.

            Пусть $f_n$ дифференцируема на множестве $D$, $f_n' \overset{D}{\rightrightarrows} g$ и существует точка $c \in D$, что $\{f_n(c)\}$ сходится.

            Тогда существует такая предельная функция $f$, что $f_n \overset{D}{\to} f$. что $f$ дифференцируема и $f' = g$. И если $D$ ограничено, то $f_n \overset{D}{\rightrightarrows} f$.
    ...
    \defitem{Сформулируйте теорему о почленном интегрировании функциональной последовательности.}
        ...
        \begin{theorem*}
            ...
            Пусть $f_n$ непрерывна на $D$ и $f_n \overset{D}{\rightrightarrows} f$. Заметим, что из последнего условия следует непрерывность $f$ на $D$.

            Тогда
            \begin{equation*}
                \int_a^x f_n(t) dt \overset{D}{\rightrightarrows} \int_a^x f(t) dt.
            \end{equation*}
    ...
    \defitem{Сформулируйте критерий Коши равномерной сходимости функционального ряда.}
        ...
        \begin{theorem*}
            Функциональный ряд $\sum_{n=1}^{\infty} a_n(x)$ сходится равномерно на $D \iff$ $\forall \eps > 0$ $\exists N(\eps)$, $\forall n \geq N$, $\forall m$: 
            $$||a_n + a_{n + 1} + \dots + a_{n + m}|| < \eps$$
            
            Т.е. $|a_n(x) + a_{n + 1}(x) + \dots + a_{n + m}(x)| < \eps$ $\forall x \in D$.
        \end{theorem*}
    ...
    \defitem{Сформулируйте следствие критерия Коши -- достаточное условие того, что функциональный ряд не является сходящимся равномерно.}
        ...
        \begin{corollary}
            (Отрицание критерия Коши) Если $\exists \{x_n\} \subset D$, $\exists \{m_n\} \in \NN$, $\exists \eps_0$:
            $$|a_n(x_n) + a_{n + 1}(x_n) + \dots + a_{m_n}(x_n)| > \eps_0$$            
        \end{corollary}
    ...
    \defitem{Сформулируйте и докажите теорему Абеля о сходимости степенного ряда.}
        ...
        \begin{proof}
            \begin{enumerate}
                ...
                \sum_{n = m}^{N} \left|c_n \cdot (x_1 - x_0)^n \right| \cdot \left|\left(\frac{x-x_0}{x_1 - x_0}\right)^n\right| \leq \eps (q^m + \dots + q^N) \leq \eps \cdot q^m \cdot \frac{1}{1-q} \to 0$
            \end{enumerate}
        \end{proof}
    ...
    \defitem{Пусть $R$ -- радиус сходимости степенного ряда. Сформулируйте и докажите теорему о равномерной сходимости степенного ряда на $[0; R]$.}
        ...
        \begin{theorem*}
            Пусть $\displaystyle \sum c_n R^n$ сходится. Тогда степенной ряд
    ...
    \begin{enumerate}
        \item $e^x = \sum_{n=0}^\infty \frac{x^n}{n!}$, $R = \infty$
                ...
                Докажем равенство. Оценим остаток по формуле Лагранжа.

                $r_N(x) = \underbrace{e^{\Theta x}}_\text{const} \cdot \underbrace{\frac{x^{N+1}}{\left(N + 1\right)!}}_{\to 0 \text{ при }\forall x}$, $\Theta \in \left(0;\ 1\right)$
            Множество сходимости~--- $\RR$, на множестве $\RR$ сумма ряда представляет собой исходную функцию.
        \item Для $\cos x$ аналогично:
            \begin{flalign*}
                & \cos x = \sum_{n=0}^\infty \left(-1\right)^n \cdot \frac{x^{2n}}{\left(2n\right)!}, x \in \RR, R = \infty
            \end{flalign*}
        \item Для $\sin x$ аналогично:
            \begin{flalign*}
                & \sin x = \sum_{n=0}^\infty \left(-1\right)^n \cdot \frac{x^{2n+1}}{\left(2n+1\right)!} x \in \RR, R = \infty
            \end{flalign*}
    \end{enumerate}
